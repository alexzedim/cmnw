...
export const DISENCHANTING = {
  ...
  methods: [
    ...
    },
    {
      ...
      description: 'Blue Item → Illumated Shards [1 → 1.8]',
    ...
    // ========================================================================
    {
      ...
      description: 'Green Item → Glowing Shards [1 → 1.2]',
    ...
    },
    {
      ...
      description: 'Blue Item → Glowing Shards [1 → 1.8]',
    ...
    // ========================================================================
    {
      ...
      description: 'Green SL Item → Enchanting Shard [1 → 1.5]',
    ...
    },
    {
      ...
      description: 'Blue SL Item → Enchanting Shard [1 → 2.5]',
    ...
    },
    {
      ...
      description: 'Purple SL Item → Vibrant Shard + Vibrant Dust [1 → 2 shards + 8 dust]',
    ...
    // ========================================================================
    {
      ...
      description: 'Green DF Item * → Chromatic Dust * [1 → 1.0]',
    ...
    },
    {
      ...
      ticker: PROF_ENCH,
      names: { source: 'Green Item (DF) **', target: 'Chromatic Dust **' },
      description: 'Green DF Item ** → Chromatic Dust ** [1 → 1.5]',
    ...
    },
    {
      ...
      description: 'Blue DF Item * → Chromatic Shard * [1 → 2.0]',
    ...
    },
    {
      ...
      ticker: PROF_ENCH,
      names: { source: 'Blue Item (DF) **', target: 'Chromatic Shards **' },
      description: 'Blue DF Item ** → Chromatic Shard ** [1 → 3.0]',
    ...
    },
    {
      ...
      description: 'Purple DF Item ** → Resonant Crystal ** [1 → 2.0]',
    ...
    },
    {
      ...
      description: 'Purple DF Item *** → Vibrant Shard *** [1 → 3.0]',
