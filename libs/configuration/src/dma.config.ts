...
export const dmaConfig: IDmaConfig = {
  ...
  isPricingBuildSkillLine:
    process.env.DMA_PRICING_BUILD_SKILL_LINE === 'true',
  ...
  isPricingLabProspecting:
    process.env.DMA_PRICING_LAB_PROSPECTING === 'true',
  ...
  isValuationsFromPricing:
    process.env.DMA_VALUATIONS_FROM_PRICING === 'true',
  isValuationsFromAuctions:
    process.env.DMA_VALUATIONS_FROM_AUCTIONS === 'true',
  isValuationsForPremium:
    process.env.DMA_VALUATIONS_FOR_PREMIUM === 'true',
  isValuationsForCurrency:
    process.env.DMA_VALUATIONS_FOR_CURRENCY === 'true',
