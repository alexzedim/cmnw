 ...
 *
 * SOURCES:
 * @see fromMythicPlusLadder - Mythic+ ladder data (priority: 3)
 * @see fromPvPLadder - PvP ladder data (priority: 3)
 * @see fromWarcraftLogs - Warcraft Logs raid data (priority: 1)
 * @see fromWowProgressLfg - WoW Progress LFG data (priority: 4)
 * @see fromGuildMaster - Guild master from guild roster (priority: 1)
...
export class CharacterMessageDto {
   ...
   *
   * Priority: 3 (High - user-initiated competitive content)
   */
   ...
   *
   * Priority: 4 (Medium - community-driven content)
   */
   ...
   *
   * Priority: 1 (Very High - guild leadership data)
   */
   ...
   *
   * Priority: 4 (Low - regular guild membership updates)
   */
   ...
   *
   * Priority: 3 (Very Low - bulk data import)
   */
   ...
   *
   * Priority: 0 (Very High - user-initiated API requests)
   */
