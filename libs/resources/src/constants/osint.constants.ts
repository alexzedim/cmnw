...
export const OSINT_CHARACTER_LIMIT = 5_000;
...
export const CHARACTER_ENDPOINT_BATCH_SIZE = 3;

export const CHARACTER_ENDPOINT_BATCH_DELAY_MS = 1_000;
...
export enum OSINT_SOURCE {
  ...
  GUILD_CHARACTERS_UNIQUE = 'OSINT-CHARACTERS-UNIQUE',
  ...
  OSINT_LUA = 'OSINT-LUA',
  OSINT_MIGRATION = 'OSINT-MIGRATION',
  NAMEPLATE_GET = 'OSINT-NAMEPLATE-GET',
  NAMEPLATE_INDEX = 'OSINT-NAMEPLATE-INDEX',
  WHO_GET = 'OSINT-WHO-GET',
  WHO_INDEX = 'OSINT-WHO-INDEX',
  CHAT_GET = 'OSINT-CHAT-GET',
  CHAT_INDEX = 'OSINT-CHAT-INDEX',
  CLEU_GET = 'OSINT-CLEU-GET',
  CLEU_INDEX = 'OSINT-CLEU-INDEX',
}
